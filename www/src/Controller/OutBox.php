...
class OutBox extends AbstractController
{
	...
	public function send(): JsonResponse {
		...
		$host = "mastodon.social";//$inbox_host;
		$path = '/inbox';
		...
		file_put_contents("outfollow.txt",print_r($message_json, true));
		file_put_contents("outheaders.txt",print_r($headers, true));

		// Specify the URL of the remote server
		$remoteServerUrl = "https://mastodon.social/inbox";//$inbox_actor . "/inbox";

		file_put_contents("outremote.txt", $remoteServerUrl);
